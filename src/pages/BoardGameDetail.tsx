  ...
  return (
    <div className="min-h-screen bg-[#0B1E33] text-[#EAF0F6]">
      ...
      <div className="relative h-64 w-full overflow-hidden sm:h-80 md:h-96">
        ...
        {game.favorite && (
          <span className="absolute right-6 top-6 inline-flex items-center gap-1.5 rounded-full bg-[#FF3D81]/90 px-3.5 py-1.5 text-xs font-bold uppercase tracking-wider text-white shadow-md">
