...
export const boardgames: BoardGame[] = [
  {
    ...
    favorite: true,
    played: true,
    pros: "Molto divertente, rispecchia bene il tema della serie animata.\nPartite veloci e semplici da spiegare.",
    cons: "Può essere molto caotico con 6 giocatori.\nLa fortuna gioca un ruolo fondamentale.",
  ...
  slug: "mysterium",
  title: "Mysterium",
  subtitle: "Diventa un medium e leggi visioni spettrali per risolvere l'omicidio di un fantasma inquieto.",
  coverImageUrl: "/images/mysterium.jpg",
  description: "Negli anni Venti, il signor MacDowell, un astrologo dotato, rilevò immediatamente un essere soprannaturale entrando nella sua nuova casa in Scozia. Ha radunato eminenti medium del suo tempo per una seduta spiritica straordinaria, e hanno sette ore per entrare in contatto con il fantasma e indagare su eventuali indizi che possa fornire per svelare un vecchio mistero.\n\nIncapace di parlare, il fantasma amnesico comunica con i medium attraverso visioni, che nel gioco sono rappresentate da carte illustrate. I medium devono decifrare le immagini per aiutare il fantasma a ricordare come è stato assassinato: Chi ha commesso il crimine? Dove si è svolto? Quale arma ha causato la morte? Più i medium collaborano e indovinano, più è facile individuare il colpevole giusto.",
  type: "Cooperativo",
  genres: ["Party Game", "Mistero", "Cooperativo"],
  rating: 4,
  playerCount: "2-7",
  duration: "45 minuti",
  ageRange: "12+",
  ...
  {
    id: "eroi-di-barcadia",
    slug: "eroi-di-barcadia",
    title: "Eroi di Barcadia",
    subtitle: "Avventuratevi responsabilmente!",
    ...
    duration: "90 minuti",
    ageRange: "18+",
    notes: "'Eroi di Barcadia' può essere giocato anche senza bere alcol.",
    favorite: true,
    played: true,
    officialUrl: "https://www.craniocreations.it/prodotto/eroi-di-barcadia",
    downloads: [
      {
        id: "eroi-di-barcadia-regolamento",
        label: "Regolamento",
        description: "Manuale italiano, 8 pagine.",
        fileUrl: "/pdfs/eroi-di-barcadia_1.pdf",
  ...
  duration: "60 minuti",
  ageRange: "10+",
  notes: "Vincitore ufficiale del 'Kennerspiel des Jahres award' (Enthusiast Game of the Year) 2026.",
  favorite: false,
  played: false,
  officialUrl: "https://mighty-boards.com/7-rebirth-international-english-edition.html",
  downloads: [
    {
      id: "rebirth-regolamento",
      label: "Regolamento",
      description: "Regolamento ENG, 8 pagine.",
      fileUrl: "/pdfs/rebirth_1.pdf",
      icon: "fa-solid fa-book",
      fileSize: "5.7 MB",
    },
  ],
  ...
  {
  id: "caos-a-neverwinter",
  slug: "caos-a-neverwinter",
  title: "D&D Caos a Neverwinter",
  subtitle: "Indaga sulle sparizioni a Icewind Dale in questa avventura in tre parti.",
  coverImageUrl: "/images/caos-a-neverwinter.jpg",
  description: "Unisciti a un gruppo di compagni avventurieri che indagano su una serie di allarmanti sparizioni ad Icewind Dale in questo escape game da tavolo a tema D&D single-play per 2-6 giocatori.\n\nQuesta avventura può essere suddivisa in 3 sessioni di gioco o giocata in un'unica eroica sessione. Inizia creando il tuo personaggio. Poi esplora una modesta taverna, combatti in battaglie epiche contro mostri iconici di D&D e intraprendi in una caccia selvaggia attraverso l'Underdark alle calcagna di un mago malvagio e del suo pericoloso culto per svelare il mistero dei loro malvagi piani.",
  type: "Excape Game",
  genres: ["D&D", "stategioo", "dadi", "escape game"],
  rating: 3,
  synopsis: "L'unico modo per trovare le persone scomparse e sfuggire agli ostacoli è esplorare stanze, risolvere enigmi e raccogliere indizi per risolvere il mistero alla fine di ogni atto.",
  playerCount: "2-6 giocatori",
  duration: "90 minuti circa ad avventura",
  ageRange: "12+",
  pros: "Avventure interessanti, PG ben strutturati ed enigmi degni di tale nome.",
  cons: "Scarsa rigiocabilità",
  favorite: false,
  played: true,
  officialUrl: "https://boardgamegeek.com/boardgame/379699/dungeons-and-dragons-bedlam-in-neverwinter",
  downloads: [],
  },
  {
    id: "mycelia",
  ...
  },
  {
    ...
    slug: "limpiccione",
    title: "L'Impiccione",
    subtitle: "Riuscirete a sfuggire ai... feder-ali?",
    coverImageUrl: "/images/limpiccione.jpg",
    description: "In questo gioco di rapidità e memoria, solo il più scaltro riuscirà ad assicurarsi la vittoria. Ciascun giocatore ha di fronte a sé la sua scena del crimine, composta da quattro carte coperte, che possono essere numerate (i testimoni) o speciali (di ogni tipo). Il tuo obiettivo è riuscire ad avere la scena del crimine dal valore più basso di tutti alla fine della partita.",
    type: "Filler",
    genres: ["Party Game", "Carte", "Strategico", "Competitivo", "Filler"],
    rating: 1,
    synopsis: "Al tuo turno peschi una carta, che puoi guardare e scambiare con una della tua scena del crimine. Rivela a tutti la carta che hai preso dalla tua scena del crimine. Se è una carta speciale, eseguine l'effetto, ma se è una carta Testimone, è aperta la sfida: tutti i giocatori possono cercare un testimone dello stesso valore da una qualsiasi scena del crimine, e il primo che ci riesce si libera di una carta dalla sua scena del crimine! Quando qualcuno \"bussa\", tutti svolgono un ultimo turno e poi si verifica chi vince. Ricorda le carte coperte della tua scena del crimine, scopri dove si nascondono i testimoni, e sarai il picciotto vincitore!",
    playerCount: "2-6 giocatori",
    duration: "15 minuti",
    ageRange: "8+",
    notes: "Un gioco per chi ama i piccioni e odia i propri amici. Autore: Nate Miller. Illustrazioni: Jon Yetter",
    favorite: false,
    played: true,
